...
import linkBuildingRoutes from "./routes/linkBuildingRoutes";
import guestPostingRoutes from "./routes/guestPostingRoutes";
...
app.use("/api/v1/link-building-packages", linkBuildingRoutes);
app.use("/api/v1/guest-posting-packages", guestPostingRoutes);
